    ...
    <body>
        <div id="Contenedor">
            ...
            <form action="./html/libros_buscados.php" method="POST" id="iniciar">
                <button class="Boton_Busqueda" type="submit"><img class="Icono" src="Miselaneos/Icono_Busqueda.png"alt=""></button>
                ...
                <form action="./html/Carrito.php">
                    <button id="Boton_Carrito"><img src="Miselaneos/icons8-carrito-de-la-compra-cargado-64.png"alt=""></button>
                </form>
            ...
            <div id="Contenido">
                ...
                <h2 style="text-align: center;">Los Mas Vendidos</h2>
                <table>
                    <tbody id="tabla_rec">
                        <?php
            ...
            <footer id="Pie_de_Pagina">
                <h2 style="text-align:center;">BookShelf</h2><br><h4 style="text-align:center;">Librerias</h4>
                <div Redes></div>
            </footer>
